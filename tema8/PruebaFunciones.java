...
if (misfunciones.Varias.esPrimo(n)) {
...
System.out.print("Introduzca un número entero positivo: ");
n = Integer.parseInt(System.console().readLine());
System.out.println(n + " tiene " + misfunciones.Varias.digitos(n) + " dígitos.");
...
System.out.println("El volumen del cilindro es " + misfunciones.Geometria.volumenCilindro(r, h) + "m3");
}
}